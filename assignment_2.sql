...
SELECT first_name ,manager_id ,salary  FROM  employees where department_id =101 order by salary asc;  
...
SELECT first_name ,last_name from employees WHERE first_name like 'A%' and SUBSTRING(last_name,2,2)='TH';  